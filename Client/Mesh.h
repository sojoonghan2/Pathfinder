...
public:
	...
	shared_ptr<Buffer>	GetBoneFrameDataBuffer(int32 index = 0) { return _frameBuffer[index]; } // 전체 본 프레임 정보
...
private:
	...
	shared_ptr<Buffer>	_offsetBuffer; // 각 뼈의 offset 행렬
	vector<shared_ptr<Buffer>> _frameBuffer; // 전체 본 프레임 정보
};
