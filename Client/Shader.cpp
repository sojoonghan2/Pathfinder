...
void Shader::SetPipelineStateDesc(const ShaderInfo& info)
{
	...
	{
	case RASTERIZER_TYPE::CULL_BACK: rs.CullMode = D3D12_CULL_MODE_BACK; break;
	case RASTERIZER_TYPE::CULL_FRONT: rs.CullMode = D3D12_CULL_MODE_FRONT; break;
	case RASTERIZER_TYPE::CULL_NONE: rs.CullMode = D3D12_CULL_MODE_NONE; break;
	...
	D3D12_DEPTH_STENCIL_DESC& ds = _graphicsPipelineDesc.DepthStencilState;
	switch (info.depthStencilType)
	{
	case DEPTH_STENCIL_TYPE::LESS: ds.DepthEnable = TRUE; ds.DepthFunc = D3D12_COMPARISON_FUNC_LESS; break;
	case DEPTH_STENCIL_TYPE::LESS_EQUAL: ds.DepthEnable = TRUE; ds.DepthFunc = D3D12_COMPARISON_FUNC_LESS_EQUAL; break;
	case DEPTH_STENCIL_TYPE::GREATER: ds.DepthEnable = TRUE; ds.DepthFunc = D3D12_COMPARISON_FUNC_GREATER; break;
	case DEPTH_STENCIL_TYPE::GREATER_EQUAL: ds.DepthEnable = TRUE; ds.DepthFunc = D3D12_COMPARISON_FUNC_GREATER_EQUAL; break;
	case DEPTH_STENCIL_TYPE::NO_DEPTH_TEST: ds.DepthEnable = FALSE; break;
