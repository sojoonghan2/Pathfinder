...
#pragma region TerrainCube
	{
		...
		}
		{
			...
			shared_ptr<Texture> texture = GET_SINGLE(Resources)->Load<Texture>(L"Crash", L"..\\Resources\\Texture\\TerrainCube\\Crash.jpg");
			shared_ptr<Texture> floorTexture = GET_SINGLE(Resources)->Load<Texture>(L"CrashFloor", L"..\\Resources\\Texture\\TerrainCube\\CrashFloor.jpg");
			shared_ptr<Texture> topTexture = GET_SINGLE(Resources)->Load<Texture>(L"CrashTop", L"..\\Resources\\Texture\\TerrainCube\\CrashTop.jpg");
